...
import {Label, Table, Button, Checkbox, Grid, Row, Col, Nav, Tab, NavItem} from 'react-bootstrap';
...
export default class Main extends Component {
  ...
  render() {
    const {loading, followers, followings, mutual, nonMutual, notifications} = this.state;
    const {FollowerTable, FollowingTable, Spinner, NotificationTable} = Components;
